...
namespace SAE_01.Model /// A MODIFIER SI VOTRE PROJET A UN AUTRE NOM
{
    ...
    public class DataAccessTest
    {
        ...
        public bool OpenConnection()
        {
            try
            {
                ...
                {
                    ConnectionString = "Server=srv-peda-new;port=5433;Database=matinfo_test;Search Path=test;uid=lamyeva;password=rnyJLN; " // A MODIFIER POUR VOTR BD
                };
                NpgSQLConnect.Open();
